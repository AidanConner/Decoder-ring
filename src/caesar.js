...
const caesarModule = (function () {
  ...
  function createShiftedArray(string, shift) {
    let shiftedArray = getArrFromStr(string).map((character) => {
  ...
  ///note to self, go back to see the example of if statments to differentiate
